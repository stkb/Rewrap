...
import { LineType, wrapText, wrapLinesDetectingTypes } from '../src/Wrapping'

suite("Wrapping", () => 
{
  // Tests that deal with line types need to go somewhere else
  //
  suite.skip("wrapLinesDetectingTypes", () => 
  {
