/** A jsdoc-style comment on a single line. When this gets wrapped, new lines
 ...
 *  line, and the text will be indented the same amount the first line. */
  ...
  * appear in the middle of a line, like that last one, should be wrapped within
  * the paragraph as normal.
  * @constuctor
  * @description Duis condimentum non lectus ut posuere. Vivamus varius, metus
  * et efficitur ornare, risus quam condimentum lacus, eu commodo felis lorem
  * non tortor.
