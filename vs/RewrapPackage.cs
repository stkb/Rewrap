...
namespace VS
{
    ...
    /// These attributes tell the pkgdef creation utility what data to put into .pkgdef
    /// file.
    /// </para>
    /// <para>
    ...
    public sealed class RewrapPackage : Microsoft.VisualStudio.Shell.AsyncPackage
    {
        ...
        // Inside this constructor you can place any initialization code that does not
        // require any Visual Studio service because at this point the package object is
        // created but not sited yet inside Visual Studio environment. The place to do all
        // the other initialization is the Initialize method.
        public RewrapPackage()
        {
        }

        /// Initialization of the package; this method is called right after the package
        /// is sited, so this is the place where you can put all the initialization code
        /// that rely on services provided by VisualStudio.
